...
class Booking extends Component {
    ...
    render() {
        ...
        <div className='booking'>
            <ToastContainer />
            <h3 className='booking-price'>{rental.dailyRate} <span className="text-danger">đ̲</span> <span className='booking-per-night font-weight-bold'>/ đêm</span></h3>
            <hr/>
            {
                !isAuth && 
                <Link className='btn btn-bwm btn-confirm btn-primary text-center p-4 w-100' to={{pathname: '/login'}}>
            ...
            {   isAuth &&
                <React.Fragment>
                    <div className='form-group'>
                        <label htmlFor='dates' className="font-weight-bold">Ngày </label>
                    ...
                    <div className='form-group'>
                        <label className='guests font-weight-bold'>Số khách</label>
                    ...
                    <button disabled={!startAt || !endAt || !guests} onClick={() => this.confirmPropseData()} className='btn btn-bwm btn-confirm btn-primary w-100'>Đặt phòng</button>
                </React.Fragment>
            }
